...
public class CommonInvoiceServiceImpl implements CommonInvoiceService {
  ...
  public List<InvoiceLine> createInvoiceLinesFromOrder(
      Invoice invoice, BigDecimal inTaxTotal, Product invoicingProduct, BigDecimal percentToInvoice,SaleOrder saleOrder)
      throws AxelorException {

       //get list sale order lines
    List<SaleOrderLine> saleOrderLineList = saleOrder.getSaleOrderLineList(); 
   //count saleOrderLine
   int countSaleOrderLine = saleOrderLineList.size();
   ...
   BigDecimal lineAmountToInvoice =
       percentToInvoice
           ...
           .divide(BigDecimal.valueOf(countSaleOrderLine), 4, BigDecimal.ROUND_HALF_UP);
   ...
   for (SaleOrderLine saleOrderLine : saleOrderLineList){
       ...
       new InvoiceLineGenerator(
           ...
           BigDecimal.ONE,
           saleOrderLine.getProduct().getUnit(),
           null,
