...
public class SaleOrderInvoiceServiceImpl implements SaleOrderInvoiceService {
  ...
  public Invoice createInvoiceAndLines(
   ...
   // List<Map<String, Object>> saleOrderLineList = saleOrder.getSaleOrderLineList();


    List<InvoiceLine> invoiceLinesList = commonInvoiceService.createInvoiceLinesFromOrder(
                invoice, saleOrder.getInTaxTotal(), invoicingProduct, percentToInvoice, saleOrder);
